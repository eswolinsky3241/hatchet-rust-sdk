...
impl UserListTenantInvites200ResponseRowsInner {
    pub fn new(metadata: models::V1TaskGet200ResponseMetadata, email: String, role: Role, tenant_id: String, expires: String) -> UserListTenantInvites200ResponseRowsInner {
