...
impl V1WebhookList200ResponseRowsInner {
    pub fn new(metadata: models::V1TaskGet200ResponseMetadata, tenant_id: String, name: String, source_name: SourceName, event_key_expression: String, auth_type: AuthType) -> V1WebhookList200ResponseRowsInner {
