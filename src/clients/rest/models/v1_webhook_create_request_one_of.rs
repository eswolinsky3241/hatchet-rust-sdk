...
pub struct V1WebhookCreateRequestOneOf {
    ...
    #[serde(rename = "auth")]
    pub auth: Box<models::V1WebhookCreateRequestOneOfAllOfAuth>,
}

impl V1WebhookCreateRequestOneOf {
    pub fn new(source_name: SourceName, name: String, event_key_expression: String, auth_type: AuthType, auth: models::V1WebhookCreateRequestOneOfAllOfAuth) -> V1WebhookCreateRequestOneOf {
        V1WebhookCreateRequestOneOf {
            source_name,
            name,
