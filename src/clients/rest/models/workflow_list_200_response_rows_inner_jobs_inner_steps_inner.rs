...
impl WorkflowList200ResponseRowsInnerJobsInnerStepsInner {
    pub fn new(metadata: models::V1TaskGet200ResponseMetadata, readable_id: String, tenant_id: String, job_id: String, action: String) -> WorkflowList200ResponseRowsInnerJobsInnerStepsInner {
