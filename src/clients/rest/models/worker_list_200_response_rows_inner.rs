...
pub struct WorkerList200ResponseRowsInner {
    ...
    /// The time this worker last sent a heartbeat.
    #[serde(rename = "lastListenerEstablished", skip_serializing_if = "Option::is_none")]
...
impl WorkerList200ResponseRowsInner {
    pub fn new(metadata: models::V1TaskGet200ResponseMetadata, name: String, r#type: Type) -> WorkerList200ResponseRowsInner {
