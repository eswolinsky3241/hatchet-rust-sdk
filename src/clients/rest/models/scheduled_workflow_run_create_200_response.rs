...
pub struct ScheduledWorkflowRunCreate200Response {
    ...
    #[serde(rename = "workflowRunCreatedAt", skip_serializing_if = "Option::is_none")]
...
impl ScheduledWorkflowRunCreate200Response {
    pub fn new(metadata: models::V1TaskGet200ResponseMetadata, tenant_id: String, workflow_version_id: String, workflow_id: String, workflow_name: String, trigger_at: String, method: Method) -> ScheduledWorkflowRunCreate200Response {
