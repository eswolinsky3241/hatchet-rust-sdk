...
pub struct V1EventList200ResponseRowsInner {
    ...
    #[serde(rename = "triggeringWebhookName", skip_serializing_if = "Option::is_none")]
    pub triggering_webhook_name: Option<String>,
}

impl V1EventList200ResponseRowsInner {
    pub fn new(metadata: models::V1TaskGet200ResponseMetadata, key: String, tenant_id: String, workflow_run_summary: models::V1EventList200ResponseRowsInnerWorkflowRunSummary) -> V1EventList200ResponseRowsInner {
