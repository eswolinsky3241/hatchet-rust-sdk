...
/// TenantMembershipsList200ResponseRowsInnerTenant : The tenant associated with this tenant member.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TenantMembershipsList200ResponseRowsInnerTenant {
...
impl TenantMembershipsList200ResponseRowsInnerTenant {
    /// The tenant associated with this tenant member.
    pub fn new(metadata: models::V1TaskGet200ResponseMetadata, name: String, slug: String, version: Version) -> TenantMembershipsList200ResponseRowsInnerTenant {
        TenantMembershipsList200ResponseRowsInnerTenant {
