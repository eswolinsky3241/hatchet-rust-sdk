...
pub struct WorkflowRunGetShape200Response {
...
impl WorkflowRunGetShape200Response {
    pub fn new(metadata: models::V1TaskGet200ResponseMetadata, tenant_id: String, workflow_version_id: String, status: Status, triggered_by: models::WorkflowRunCreate200ResponseJobRunsInnerWorkflowRunTriggeredBy) -> WorkflowRunGetShape200Response {
        WorkflowRunGetShape200Response {
