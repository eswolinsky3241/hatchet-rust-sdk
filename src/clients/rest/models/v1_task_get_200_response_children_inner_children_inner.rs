...
pub struct V1TaskGet200ResponseChildrenInnerChildrenInner {
...
impl V1TaskGet200ResponseChildrenInnerChildrenInner {
    pub fn new(metadata: models::V1TaskGet200ResponseMetadata, created_at: String, display_name: String, input: serde_json::Value, num_spawned_children: i32, output: serde_json::Value, status: Status, task_external_id: uuid::Uuid, task_id: i32, task_inserted_at: String, tenant_id: uuid::Uuid, r#type: Type, workflow_id: uuid::Uuid, workflow_run_external_id: uuid::Uuid) -> V1TaskGet200ResponseChildrenInnerChildrenInner {
        V1TaskGet200ResponseChildrenInnerChildrenInner {
