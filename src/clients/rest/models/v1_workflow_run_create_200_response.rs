...
impl V1WorkflowRunCreate200Response {
    pub fn new(run: models::V1WorkflowRunCreate200ResponseRun, task_events: Vec<models::V1TaskEventList200ResponseRowsInner>, shape: Vec<models::V1WorkflowRunCreate200ResponseShapeInner>, tasks: Vec<models::V1TaskGet200ResponseChildrenInner>) -> V1WorkflowRunCreate200Response {
