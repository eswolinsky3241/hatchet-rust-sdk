...
impl V1WebhookCreateRequestOneOf1 {
    pub fn new(source_name: SourceName, name: String, event_key_expression: String, auth_type: AuthType, auth: models::V1WebhookCreateRequestOneOf1AllOfAuth) -> V1WebhookCreateRequestOneOf1 {
