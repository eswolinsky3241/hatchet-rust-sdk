...
pub async fn step_run_get(
    configuration: &configuration::Configuration,
    tenant: &str,
    step_run: &str,
) -> Result<models::StepRunGet200Response, Error<StepRunGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_tenant = tenant;
    let p_step_run = step_run;

    let uri_str = format!(
        "{}/api/v1/tenants/{tenant}/step-runs/{step_run}",
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::StepRunGet200Response`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::StepRunGet200Response`"
                ))));
            }
        }
    } else {
...
pub async fn step_run_get_schema(
    configuration: &configuration::Configuration,
    tenant: &str,
    step_run: &str,
) -> Result<serde_json::Value, Error<StepRunGetSchemaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_tenant = tenant;
    let p_step_run = step_run;

    let uri_str = format!(
        "{}/api/v1/tenants/{tenant}/step-runs/{step_run}/schema",
        configuration.base_path,
        tenant = crate::clients::rest::apis::urlencode(p_tenant),
        step_run = crate::clients::rest::apis::urlencode(p_step_run)
    );
...
pub async fn step_run_list_archives(
    configuration: &configuration::Configuration,
    step_run: &str,
    offset: Option<i64>,
    limit: Option<i64>,
) -> Result<models::StepRunListArchives200Response, Error<StepRunListArchivesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_step_run = step_run;
    let p_offset = offset;
    let p_limit = limit;
    ...
    let uri_str = format!(
        "{}/api/v1/step-runs/{step_run}/archives",
        configuration.base_path,
        step_run = crate::clients::rest::apis::urlencode(p_step_run)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::StepRunListArchives200Response`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::StepRunListArchives200Response`"
                ))));
            }
        }
    } else {
...
pub async fn step_run_list_events(
    configuration: &configuration::Configuration,
    step_run: &str,
    offset: Option<i64>,
    limit: Option<i64>,
) -> Result<models::StepRunListEvents200Response, Error<StepRunListEventsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_step_run = step_run;
    let p_offset = offset;
    let p_limit = limit;
    ...
    let uri_str = format!(
        "{}/api/v1/step-runs/{step_run}/events",
        configuration.base_path,
        step_run = crate::clients::rest::apis::urlencode(p_step_run)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::StepRunListEvents200Response`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::StepRunListEvents200Response`"
                ))));
            }
        }
    } else {
...
pub async fn step_run_update_cancel(
    configuration: &configuration::Configuration,
    tenant: &str,
    step_run: &str,
) -> Result<models::StepRunGet200Response, Error<StepRunUpdateCancelError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_tenant = tenant;
    let p_step_run = step_run;

    let uri_str = format!(
        "{}/api/v1/tenants/{tenant}/step-runs/{step_run}/cancel",
        configuration.base_path,
        tenant = crate::clients::rest::apis::urlencode(p_tenant),
        step_run = crate::clients::rest::apis::urlencode(p_step_run)
    );
...
/// Reruns a step run
pub async fn step_run_update_rerun(
    configuration: &configuration::Configuration,
    tenant: &str,
    step_run: &str,
    step_run_update_rerun_request: models::StepRunUpdateRerunRequest,
) -> Result<models::StepRunGet200Response, Error<StepRunUpdateRerunError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_tenant = tenant;
    let p_step_run = step_run;
    ...
    let uri_str = format!(
        "{}/api/v1/tenants/{tenant}/step-runs/{step_run}/rerun",
        configuration.base_path,
        tenant = crate::clients::rest::apis::urlencode(p_tenant),
        step_run = crate::clients::rest::apis::urlencode(p_step_run)
    );
...
pub async fn workflow_run_list_step_run_events(
    configuration: &configuration::Configuration,
    tenant: &str,
    workflow_run: &str,
    last_id: Option<i32>,
) -> Result<models::StepRunListEvents200Response, Error<WorkflowRunListStepRunEventsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_tenant = tenant;
    ...
    let uri_str = format!(
        "{}/api/v1/tenants/{tenant}/workflow-runs/{workflow_run}/step-run-events",
        configuration.base_path,
        tenant = crate::clients::rest::apis::urlencode(p_tenant),
