...
pub async fn tenant_memberships_list(
    configuration: &configuration::Configuration,
) -> Result<models::TenantMembershipsList200Response, Error<TenantMembershipsListError>> {
...
pub async fn user_create(
    configuration: &configuration::Configuration,
    user_create_request: Option<models::UserCreateRequest>,
) -> Result<models::UserUpdateLogin200Response, Error<UserCreateError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => {
                return Err(Error::from(serde_json::Error::custom(
                    "Received `text/plain` content type response that cannot be converted to `models::UserUpdateLogin200Response`",
                )));
            }
            ContentType::Unsupported(unknown_type) => {
                return Err(Error::from(serde_json::Error::custom(format!(
                    "Received `{unknown_type}` content type response that cannot be converted to `models::UserUpdateLogin200Response`"
                ))));
            }
        }
    } else {
...
pub async fn user_get_current(
    configuration: &configuration::Configuration,
) -> Result<models::UserUpdateLogin200Response, Error<UserGetCurrentError>> {
...
pub async fn user_update_github_oauth_callback(
    configuration: &configuration::Configuration,
) -> Result<(), Error<UserUpdateGithubOauthCallbackError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UserUpdateGithubOauthCallbackError> =
...
pub async fn user_update_github_oauth_start(
    configuration: &configuration::Configuration,
) -> Result<(), Error<UserUpdateGithubOauthStartError>> {
...
/// Completes the OAuth flow
pub async fn user_update_google_oauth_callback(
    configuration: &configuration::Configuration,
) -> Result<(), Error<UserUpdateGoogleOauthCallbackError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UserUpdateGoogleOauthCallbackError> =
            serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
...
/// Starts the OAuth flow
pub async fn user_update_google_oauth_start(
    configuration: &configuration::Configuration,
) -> Result<(), Error<UserUpdateGoogleOauthStartError>> {
...
/// Logs in a user.
pub async fn user_update_login(
    configuration: &configuration::Configuration,
    user_update_login_request: Option<models::UserUpdateLoginRequest>,
) -> Result<models::UserUpdateLogin200Response, Error<UserUpdateLoginError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Logs out a user.
pub async fn user_update_logout(
    configuration: &configuration::Configuration,
) -> Result<models::UserUpdateLogin200Response, Error<UserUpdateLogoutError>> {
...
pub async fn user_update_password(
    configuration: &configuration::Configuration,
    user_update_password_request: Option<models::UserUpdatePasswordRequest>,
) -> Result<models::UserUpdateLogin200Response, Error<UserUpdatePasswordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
/// Completes the OAuth flow
pub async fn user_update_slack_oauth_callback(
    configuration: &configuration::Configuration,
) -> Result<(), Error<UserUpdateSlackOauthCallbackError>> {
...
/// Starts the OAuth flow
pub async fn user_update_slack_oauth_start(
    configuration: &configuration::Configuration,
    tenant: &str,
) -> Result<(), Error<UserUpdateSlackOauthStartError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_tenant = tenant;
